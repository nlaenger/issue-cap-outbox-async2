...
export default { name: 'main_service' }
...
Object.defineProperty(Belege, 'name', { value: 'main_service.Belege' })
export class Belege_ extends Array<Belege> {}
Object.defineProperty(Belege_, 'name', { value: 'main_service.Belege' })
...
Object.defineProperty(Positionen, 'name', { value: 'main_service.Positionen' })
export class Positionen_ extends Array<Positionen> {}
Object.defineProperty(Positionen_, 'name', { value: 'main_service.Positionen' })
...
Object.defineProperty(Arbeitsschritte, 'name', { value: 'main_service.Arbeitsschritte' })
export class Arbeitsschritte_ extends Array<Arbeitsschritte> {}
Object.defineProperty(Arbeitsschritte_, 'name', { value: 'main_service.Arbeitsschritte' })
...
// function
export declare const Test1: { (): string | null, __parameters: {}, __returns: string | null };
// function
export declare const Test2: { (): string | null, __parameters: {}, __returns: string | null };
// function
export declare const Test3: { (): string | null, __parameters: {}, __returns: string | null };